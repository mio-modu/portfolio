...
const STEPS = [
  ...
  },
  {
    ...
    file: "Supabase",
    title: "면허증 수동 인증",
    desc: "면허·자격증 번호를 자동으로 검증해주는 공개 정부 API는 사업자등록과 달리 찾지 못했습니다. 그래서 이 경로는 서류 업로드와 사람의 확인으로 설계했습니다.",
    points: [
    ...
    >
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <section style={{ paddingTop: 120 }}>
          ...
          >
            회원 자격을 어떻게 검증할 것인가. 같은 면허·자격을 가지고도
            사업자등록이 있는 사람과 없는 사람이 섞여 있어, 인증 경로를 둘로
            나눠 직접 구현한 연습 프로젝트입니다.
          </p>
          ...
          <CaseSection
            rows={[
              {
                label: "문제",
                text: "면허·자격 보유자를 대상으로 한 회원제 서비스를 제안받고 조사해보니, 자격 검증은 한 가지 방법으로 풀리지 않았습니다. 같은 자격을 가지고도 사업자등록이 있는 사람과 없는 사람이 함께 존재하기 때문입니다. 인증 방식을 하나만 두면 절반은 가입 자체가 막힙니다.",
              },
              {
                label: "해결",
