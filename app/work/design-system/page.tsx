  ...
  [
    {
      ...
      items: [
        ...
        },
        {
          ...
          did: "세 장면이 차례로 지나갑니다. 처음에는 사진 세 장을 한 줄로 이어 붙여 옆으로 밀었는데, 그러면 화면 오른쪽 끝에 다음 사진이 비집고 들어와 지저분해집니다. 그래서 세 장면을 같은 자리에 겹쳐 두고, 움직임은 각 화면 안에서만 만들었습니다. 사진을 화면보다 크게 잡아 두면 아무리 움직여도 빈 곳이 생기지 않습니다. 장면이 바뀌는 방식은 잘 만든 사이트의 화면 녹화를 프레임 단위로 뜯어서 알아냈습니다 — 글자가 배경보다 먼저 바뀝니다. 눈이 글자를 따라가는 사이에 배경이 넘어가서, 바뀌는 순간을 알아채지 못합니다. 글자를 0.9초 먼저 흐려지게 한 이유입니다.",
        },
        {
          id: "T23",
          name: "동화책 삽화",
...
const FACTS = [
  ...
  { n: "2,078", u: "곳 분석", d: "국내 1,757곳과 해외 321곳. 화면을 하나씩 직접 보고 분류했습니다" },
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <section style={{ padding: "72px 0 0" }}>
          ...
          >
            ...
            어렵습니다. 그래서 실제로 운영 중인 국내외 사이트 2,078곳의
        ...
        <CaseSection
          rows={[
            ...
            {
              label: "한 일",
              text: "실제로 운영 중인 국내외 사이트 2,078곳을 화면으로 하나씩 열어 보며 분류했습니다. 국내 AI 서비스 833곳으로 시작해 기업 사이트 924곳, 해외 랜딩 271곳, 앱 화면 50곳을 차례로 더했습니다. 설명만 읽고 분류하면 기록이 틀어지기 때문입니다. 스타일마다 쓸 색, 요소를 놓을 자리, 그림자 세기, 사진 찍는 법, 그리고 하면 안 되는 것까지 숫자와 문장으로 적어 뒀습니다.",
            },
            {
              label: "쓰는 법",
              text: "2,078곳을 다 재보니, 스타일을 하나도 안 고치고 그대로 쓸 수 있는 화면은 넷 중 하나였습니다. 다섯 가지 기준이 전부 어긋난 화면은 한 곳도 없었고 평균 1.25개만 어긋났습니다. 그러니까 스타일은 그대로 가져다 쓰는 것이 아니라 한두 개를 틀어서 쓰는 것입니다. 가장 많이 트는 것이 밝기(30%), 가장 덜 트는 것이 색의 선명도(18%)입니다.",
            },
            {
              label: "결과",
