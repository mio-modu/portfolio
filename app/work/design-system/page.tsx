...
const FACTS = [
  ...
  { n: "2,078", u: "곳 분석", d: "국내 1,757곳 + 해외 321곳. 전부 다른 사이트이고, 화면을 하나씩 직접 보고 분류했습니다" },
  { n: "8", u: "가지 지면", d: "홈페이지 · 상세페이지 · 앱 · 관리자 화면 · 제안서 · 썸네일 · SNS · 대표 이미지" },
  { n: "19", u: "벌 제작", d: "아래가 같은 시스템에서 스타일만 바꿔 만든 결과입니다" },
];
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <section style={{ padding: "72px 0 0" }}>
          ...
          >
            ...
            어렵습니다. 그래서 실제로 운영 중인 사이트 2,078곳의 화면을 직접 보고
            25가지 스타일로 나눈 뒤, 스타일마다 색·배치·그림자·사진 쓰는 법을
        ...
        <CaseSection
          rows={[
            ...
            {
              label: "한 일",
              text: "실제로 운영 중인 사이트 2,078곳을 화면으로 하나씩 열어 보며 분류했습니다. 국내 AI 서비스 833곳으로 시작해 기업·브랜드 924곳, 해외 랜딩 271곳, 앱 화면 50곳을 차례로 더했습니다. 설명만 읽고 분류하면 기록이 틀어지기 때문입니다. 스타일마다 쓸 색, 요소를 놓을 자리, 그림자 세기, 사진 찍는 법, 그리고 하면 안 되는 것까지 숫자와 문장으로 적어 뒀습니다.",
            },
            {
              label: "다시 본 것",
              text: "AI 서비스만 833곳을 보던 동안에는 새 스타일이 12번 연속으로 안 나왔습니다. 다 모았다고 봤습니다. 그런데 기업·브랜드를 넣자 기존 23가지로는 잘 안 맞는 화면이 쏟아졌고, 남은 자리에서 두 가지가 더 나와 25가지가 됐습니다. 아래 T24와 T25가 그 둘입니다. 다 모았다는 판단은 그 분야 안에서만 맞았습니다.",
            },
            {
              label: "쓰는 법",
              text: "2,078곳을 다 재보니 스타일을 하나도 안 고치고 그대로 쓸 수 있는 화면은 넷 중 하나였습니다. 다섯 가지 기준이 전부 어긋난 화면은 한 곳도 없었고, 평균은 1.25개만 어긋났습니다. 그러니까 스타일은 그대로 가져다 쓰는 것이 아니라 한두 개를 틀어서 쓰는 것입니다. 가장 많이 트는 것이 밝기(30%), 가장 덜 트는 것이 색의 선명도(18%)입니다. 아래 T24 두 장이 같은 스타일에서 밝기만 뒤집은 예입니다.",
            },
            {
              label: "결과",
              text: "스타일을 정하면 그 규칙대로 화면이 나옵니다. 아래 19벌은 전부 같은 시스템에서 스타일만 바꿔 만든 것입니다. 색만 바꾼 것이 아니라 깊이감, 그림자 세기, 여백 비율, 사진 쓰는 법이 전부 다릅니다.",
            },
          ]}
        />
        ...
        <section style={{ marginBottom: 96 }}>
          ...
          >
            ...
            <div>
              ...
              >
                아래 19벌을 <strong>화면에 깊이를 얼마나 줄 수 있는지</strong>로
