...
const FACTS = [
  ...
  { n: "1,538", u: "곳 분석", d: "AI 서비스 833곳 + 기업·브랜드 705곳. 전부 다른 사이트이고, 화면을 하나씩 직접 보고 분류했습니다" },
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <section style={{ padding: "72px 0 0" }}>
          ...
          >
            ...
            어렵습니다. 그래서 실제로 운영 중인 사이트 1,538곳의 화면을 직접 보고
        ...
        <CaseSection
          rows={[
            ...
            {
              label: "한 일",
              text: "실제로 운영 중인 사이트 1,538곳을 화면으로 하나씩 열어 보며 분류했습니다. AI 서비스 833곳으로 시작해 기업·브랜드 705곳을 나중에 더했습니다. 설명만 읽고 분류하면 기록이 틀어지기 때문입니다. 스타일마다 쓸 색, 요소를 놓을 자리, 그림자 세기, 사진 찍는 법, 그리고 하면 안 되는 것까지 숫자와 문장으로 적어 뒀습니다.",
            },
            {
              label: "다시 확인한 것",
              text: "AI 서비스만 833곳을 보던 동안에는 새 스타일이 12번 연속으로 안 나왔습니다. 다 모았다고 봤습니다. 그런데 기업·브랜드 705곳을 넣자 기존 23가지가 그중 14%밖에 못 덮었습니다. 2010년대와 2025~26년, 두 시기 모두 정확히 14%였습니다. 남은 자리에서 두 가지가 더 나와 25가지가 됐습니다. 아래 T24와 T25가 그 둘입니다. 다 모았다는 판단은 그 분야 안에서만 맞았습니다.",
            },
            {
              label: "결과",
