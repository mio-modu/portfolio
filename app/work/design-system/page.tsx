  ...
  [
    {
      ...
      items: [
        ...
        },
        {
          ...
          did: "세 장면이 왼쪽으로 이어져 흐릅니다. 처음 만든 것은 장면이 바뀔 때마다 툭툭 끊겨 보였습니다. 잘 만든 사이트의 화면 녹화를 프레임 단위로 뜯어 보니 이유가 있었습니다 — 글자가 배경보다 먼저 움직입니다. 눈이 글자를 따라가는 사이에 배경이 넘어가서, 바뀌는 순간을 알아채지 못합니다. 그래서 글자를 배경에서 떼어내 화면에 붙박아 두고, 배경보다 0.5초 먼저 흐려지며 바뀌게 했습니다. 배경도 머무는 동안 완전히 멈추지 않고 계속 아주 느리게 흐릅니다. 멈췄다 다시 움직이면 그 순간이 끊김으로 보이기 때문입니다. 고치기 전 화면이 멈춰 있던 시간은 69%, 지금은 18%입니다.",
        },
        {
          id: "T23",
          name: "동화책 삽화",
