  ...
  [
    {
      layers: "깊이 있는 화면",
      head: "앞뒤가 느껴지는 화면",
      lede: "사진처럼 가까운 것과 먼 것이 나뉘어 보이는 스타일입니다. 브랜드를 분위기로 기억시켜야 할 때 씁니다. 23가지 중 7가지가 여기에 해당합니다.",
      items: [
        {
          id: "T09",
          name: "영화 같은 한 장면",
...
const FACTS = [
  { n: "23", u: "가지 스타일", d: "스타일마다 쓸 색, 요소를 놓을 자리, 그림자 세기, 사진 쓰는 법이 숫자로 정해져 있습니다" },
  { n: "833", u: "곳 분석", d: "전부 다른 서비스입니다. 화면을 하나씩 직접 보고 분류했습니다" },
  { n: "8", u: "가지 지면", d: "홈페이지 · 상세페이지 · 앱 · 관리자 화면 · 제안서 · 썸네일 · SNS · 대표 이미지" },
  { n: "16", u: "벌 제작", d: "아래가 같은 시스템에서 스타일만 바꿔 만든 결과입니다" },
];
      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <section style={{ padding: "72px 0 0" }}>
          ...
          >
            ...
            어렵습니다. 그래서 실제로 운영 중인 서비스 833곳의 화면을 직접 보고
            23가지 스타일로 나눈 뒤, 스타일마다 색·배치·그림자·사진 쓰는 법을
        ...
        <CaseSection
          rows={[
            ...
            {
              label: "한 일",
              text: "실제로 운영 중인 서비스 833곳을 화면으로 하나씩 열어 보며 분류했습니다. 설명만 읽고 분류하면 기록이 틀어지기 때문입니다. 스타일마다 쓸 색, 요소를 놓을 자리, 그림자 세기, 사진 찍는 법, 그리고 하면 안 되는 것까지 숫자와 문장으로 적어 뒀습니다.",
            },
            {
              label: "결과",
              text: "스타일을 정하면 그 규칙대로 화면이 나옵니다. 아래 16벌은 전부 같은 시스템에서 스타일만 바꿔 만든 것입니다. 색만 바꾼 것이 아니라 깊이감, 그림자 세기, 여백 비율, 사진 쓰는 법이 전부 다릅니다.",
            },
          ]}
        />
        ...
        <section style={{ marginBottom: 96 }}>
          ...
          >
            ...
            <div>
              ...
              >
                아래 16벌을 <strong>화면에 깊이를 얼마나 줄 수 있는지</strong>로
