      ...
      <div style={{ maxWidth: 1320, margin: "0 auto" }}>
        ...
        <ScreenSection>
          <WorkItem
            ...
            label="04 / SYSTEM"
            title="웹디자인 스타일 시스템"
            desc="국내외 사이트 2,078곳의 화면을 보고 25가지 스타일로 나눈 뒤, 스타일마다 색·배치·그림자를 숫자로 정해 둔 자체 도구. 아래는 같은 시스템에서 스타일만 바꿔 만든 20벌"
            image={
              <img
                src="/img/ds-strip.jpg"
                alt="18가지 스타일을 각각 다른 서비스에 적용한 시안 20벌 — 시네마틱 씬, 판타지 일러스트, 하이프 배너, 무광 3D 정물, 클레이 마스코트, 아날로그 접사, 데이터 지도, 게임 배지, 커머스 상세, 캐릭터 안내, UI 패널 캡처, 문서 캡처, 형광 타이포, 프로세스 다이어그램, 스탯, 모노 심볼"
                style={{
                  width: "100%",
                  aspectRatio: "1680/865",
                  objectFit: "cover",
                  display: "block",
                  background: "#F0F0F0",
                }}
